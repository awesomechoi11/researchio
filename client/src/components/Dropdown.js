...
class Dropdown extends Component {
    ...
    render() {
        ...
        const value = (
            <div className={placeholderClass} title={placeHolderValue}>
                <div className="inner">{placeHolderValue}</div>
            </div>
        );
                    ...
                    <div className={`${baseClassName}-arrow-wrapper`}>
                        {arrowOpen && arrowClosed ? (
                            ...
                            <span className={arrowClass}>
                                ...
                                >
                                    <path
                                        d="M6.54545 0.5H1.45455C0.657999 0.5 0 1.05038 0 2.07895C0 3.10752 2.62333 6.5 3.81812 6.5C5.21215 6.5 8.00026 3.10752 8 2.07895C7.99974 1.05038 7.34198 0.5 6.54545 0.5Z"
                                        fill="#6C93EC"
                                    />
                                </svg>
                            </span>
